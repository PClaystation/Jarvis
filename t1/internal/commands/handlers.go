...
$title = "T1 Agent Removal"
$deviceId = %s
$cleanupScriptPath = %s
$newline = [Environment]::NewLine
$warningOne = "A remote request asked this computer to remove the T1 agent for device ID '" + $deviceId + "'." + $newline + $newline + "Continue only if you want this agent removed from this Windows user profile."
